...
Este repositório foi criado com o intuito de armazenar os conteúdos elaborados por mim para ministrar as aulas de Python. Aqui, conterão aulas teóricas e exercícios práticos de programação básica e lógica de programação em Python.

## Aula 0 - Ambiente de Desenvolvimento Python
- [Teoria](https://github.com/Nathanbahia/curso-de-python/blob/master/00-TEORIA.md)
